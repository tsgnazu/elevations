...
! function (e, t) {
        ...
        Template7Utils = {
                ...
                for (t = 0; t < r.length; t += 1) {
                    ...
                    if ("" !== i)
                        if (i.indexOf("{{") < 0) n.push({
                            ...
                            if (0 <= i.indexOf("%7b/index.html")) continue;
                            ...
                            if (0 <= i.indexOf("{#")) {
                                ...
                                for (a = t + 1; a < r.length; a += 1)
                                    if (0 <= r[a].indexOf("{{#") && (b += 1), 0 <= r[a].indexOf("%7b%7b/index.html") && (b -= 1), 0 <= r[a].indexOf("{{#" + s)) u += r[a], g && (h += r[a]), f += 1;
            ...
            parseJsParents: function (e, n) {
                return e.split(/([+ \-*^])/g).map(function (e) {
                    ...
                    var t = e.split("http://framework7.io/kitchen-sink/").length - 1,
            ...
            getCompileVar: function (e, t, a) {
                ...
                var n, r, i = t,
                    o = 0;
                n = 0 === e.indexOf("http://framework7.io/kitchen-sink/") ? (o = e.split("http://framework7.io/kitchen-sink/").length - 1, i = "ctx_" + (1 <= (r = i.split("_")[1] - o) ? r : 1), e.split("http://framework7.io/kitchen-sink/")[o].split(".")) : 0 === e.indexOf("@global") ? (i = "Template7.global", e.split("@global.")[1].split(".")) : 0 === e.indexOf("@root") ? (i = "root", e.split("@root.")[1].split(".")) : e.split(".");
    ...
    var createPromise = function (e) {
        ...
        Device = function () {
            var e = win.navigator.platform,
                ...
                u = 0 <= t.indexOf("Edge/index.html"),
                h = 0 <= t.indexOf("Gecko/index.html") && 0 <= t.indexOf("Firefox/index.html"),
                f = "MacIntel" === e,
                m = "Win32" === e;
            if (a.ie = d, a.edge = u, a.firefox = h, i && (a.os = "windows", a.osVersion = m[2], a.windowsPhone = !0), o && !m && (a.os = "android", a.osVersion = o[2], a.android = !0, a.androidChrome = 0 <= t.toLowerCase().indexOf("chrome")), (s || p || l) && (a.os = "ios", a.ios = !0), p && !l && (a.osVersion = p[2].replace(/_/g, "."), a.iphone = !0, a.iphoneX = c), s && (a.osVersion = s[2].replace(/_/g, "."), a.ipad = !0), l && (a.osVersion = l[3] ? l[3].replace(/_/g, ".") : null, a.iphone = !0), a.ios && a.osVersion && 0 <= t.indexOf("Version/index.html") && "10" === a.osVersion.split(".")[0] && (a.osVersion = t.toLowerCase().split("version/index-2.html")[1].split(" ")[0]), a.webView = !(!(p || s || l) || !t.match(/.*AppleWebKit(?!.*Safari)/i) && !win.navigator.standalone) || win.matchMedia && win.matchMedia("(display-mode: standalone)").matches, a.webview = a.webView, a.standalone = a.webView, a.desktop = !(a.os || a.android || a.webView), a.desktop && (a.macos = f, a.windows = m), a.os && "ios" === a.os) {
    ...
    var DeviceModule = {
        ...
        Support = (Xq = !1, Yq = doc.createElement("div"), "sticky -webkit-sticky -moz-sticky".split(" ").forEach(function (e) {
            Xq || (Yq.style.position = e, Yq.style.position === e && (Xq = !0))
        }), Uq = Xq, Vq = doc.createElement("div"), {
            positionSticky: Uq,
            touch: !!("ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch),
            pointerEvents: !!(win.navigator.pointerEnabled || win.PointerEvent || "maxTouchPoints" in win.navigator),
            prefixedPointerEvents: !!win.navigator.msPointerEnabled,
            transition: (ar = Vq.style, "transition" in ar || "webkitTransition" in ar || "MozTransition" in ar),
            transforms3d: win.Modernizr && !0 === win.Modernizr.csstransforms3d || (cr = Vq.style, "webkitPerspective" in cr || "MozPerspective" in cr || "OPerspective" in cr || "MsPerspective" in cr || "perspective" in cr),
            flexbox: function () {
        ...
        Xq, Yq, cr, ar, Uq, Vq, SupportModule = {
            name: "support",
            proto: {
                support: Support
            },
    ...
    function RequestShortcut(e) {
        ...
        var i = [],
            ...
            p = i[3],
            c = i[4];
        c = "function" == typeof n[1] ? (o = (t = n)[0], l = t[1], p = t[2], t[3]) : (o = (a = n)[0], s = a[1], l = a[2], p = a[3], a[4]), [l, p].forEach(function (e) {
    ...
    var TouchModule = {
        ...
        DEFAULT_DELIMITER = "http://framework7.io/",
        DEFAULT_DELIMITERS = "index.html",
    ...
    function forward(e, t) {
        ...
        var x = "next";
        if (o.reloadCurrent || o.reloadAll ? x = "current" : o.reloadPrevious && (x = "previous"), b.addClass("page-" + x).removeClass("stacked").trigger("page:unstack"), m && h.length && h.addClass("navbar-" + x).removeClass("stacked"), o.reloadCurrent) d = C.eq(C.length - 1), v && (f = $(i.navbar.getElByPage(d)));
        ...
        if (o.reloadPrevious ? (P && !M ? P.$mount(function (e) {
            ...
            }) : o.reloadPrevious && (r.params.stackPages && 0 <= r.initialPages.indexOf(d[0]) ? (d.addClass("stacked"), d.trigger("page:stack"), v && f.addClass("stacked")) : (r.pageCallback("beforeRemove", d, f, "previous", void 0, o), r.removePage(d), v && f && f.length && r.removeNavbar(f))), o.route.route.tab && r.tabLoad(o.route.route.tab, Utils.extend({}, o, {
                history: !1,
                pushState: !1
    ...
    function navigate(e, t) {
        ...
        if ("#" === a || "" === a) return l;
        var c = a.replace("index.html", "");
        if ("/" !== c[0] && 0 !== c.indexOf("#")) {
            var d = l.currentRoute.parentPath || l.currentRoute.path;
            c = ((d ? d + "/" : "/") + c).replace("///", "http://framework7.io/").replace("//", "http://framework7.io/")
        }
    ...
    function backward(e, t) {
        ...
        if (u.length && o.removeThemeElements(u), c && (n = u.children(".navbar").children(".navbar-inner"), r = d ? (a = o.$navbarEl, 0 < n.length && u.children(".navbar").remove(), 0 === n.length && u[0].f7Page && (n = u[0].f7Page.$navbarEl), a.find(".navbar-current")) : h.children(".navbar").children(".navbar-inner")), o.allowPageChange = !1, 0 === u.length || 0 === h.length) return o.allowPageChange = !0, o;
        if (o.removeThemeElements(u), u.addClass("page-previous").removeClass("stacked").removeAttr("aria-hidden").trigger("page:unstack"), c && 0 < n.length && n.addClass("navbar-previous").removeClass("stacked").removeAttr("aria-hidden"), p.force && (0 < h.prev(".page-previous:not(.stacked)").length || 0 === h.prev(".page-previous").length))
    ...
    function back() {
        ...
        if ("#" === n && (n = void 0), n && "/" !== n[0] && 0 !== n.indexOf("#") && (n = ((o.path || "/") + n).replace("//", "http://framework7.io/")), !n && 1 < o.history.length && (n = o.history[o.history.length - 2]), (i = o.findMatchingRoute(n)) || n && (i = {
                url: n,
                path: n.split("?")[0],
            ...
            return e.forEach(function (a) {
                ...
                if ("tabs" in a && a.tabs) {
                    var t = a.tabs.map(function (e) {
                        var t = Utils.extend({}, a, {
                            path: (a.path + "/" + e.path).replace("///", "http://framework7.io/").replace("//", "http://framework7.io/"),
                            parentPath: a.path,
                            tab: e
                        });
                ...
                if ("routes" in a) {
                    var n = a.routes.map(function (e) {
                        var t = Utils.extend({}, e);
                        return t.path = (a.path + "/" + t.path).replace("///", "http://framework7.io/").replace("//", "http://framework7.io/"), t
                    });
            ...
            if (i) {
                ...
                return t.forEach(function (e) {
                    if (!o) {
                        ...
                        }), e.parentPath && (t = s.split("http://framework7.io/").slice(0, e.parentPath.split("http://framework7.io/").length - 1).join("http://framework7.io/")), o = {
                            query: l,
                            hash: p,
                            params: c,
                            url: i,
    ...
    var Modal = function (n) {
            ...
            return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.onOpen = function () {
                ...
                }), a._clientLeft = r[0].clientLeft, s ? (i && (i.removeClass("not-animated"), i.addClass("backdrop-in")), r.animationEnd(function () {
                    c()
                }), r.transitionEnd(function () {
                    c()
                }), r.removeClass("modal-out not-animated").addClass("modal-in"), a.onOpen()) : (i && i.addClass("backdrop-in not-animated"), r.removeClass("modal-out").addClass("modal-in not-animated"), a.onOpen(), a.onOpened()), a
                ...
                if (r.removeAttr("aria-hidden"), 0 === r.length && (r = a.find(".accordion-item-content")), 0 !== r.length) {
                    ...
                    0 < i.length && t.accordion.close(i), r.transitionEnd(function () {
                        a.hasClass("accordion-item-opened") ? (r.transition(0), r.css("height", "auto"), Utils.nextFrame(function () {
                            r.transition(""), a.trigger("accordion:opened"), t.emit("accordionOpened", a[0])
                        })) : (r.css("height", ""), a.trigger("accordion:closed"), t.emit("accordionClosed", a[0]))
        ...
        VirtualList = function (u) {
            ...
            return u && (e.__proto__ = u), ((e.prototype = Object.create(u && u.prototype)).constructor = e).prototype.setListSize = function () {
                ...
                this.params.showFilteredItemsOnly ? this.filteredItems = [] : (this.filteredItems = null, delete this.filteredItems), this.update()
        ...
        Tab = {
            show: function () {
                ...
                u.parent().hasClass("tabs-swipeable-wrap") && p.swiper && ((m = u.parent()[0].swiper) && m.activeIndex !== d.index() ? (v = !0, m.once("slideChangeTransitionEnd", function () {
                    f()
                }).slideTo(d.index(), s ? void 0 : 0)) : m && m.animating && (v = !0, m.once("slideChangeTransitionEnd", function () {
                    f()
                })));
                var y = u.children(".tab-active");
                if (y.removeClass("tab-active"), (!m || m && !m.animating) && (y.trigger("tab:hide"), p.emit("tabHide", y[0])), d.addClass("tab-active"), (!m || m && !m.animating) && (d.trigger("tab:show"), p.emit("tabShow", d[0])), !c && ((!(c = $("string" == typeof i ? '.tab-link[href="' + i + '"]' : '.tab-link[href="#' + d.attr("id") + '"]')) || c && 0 === c.length) && $("[data-tab]").each(function (e, t) {
    ...
    function swipePanel(s) {
        ...
        l.on("touchstart:passive", e), l.on("touchmove:active", a), l.on("touchend:passive", n), s.on("panelDestroy", function () {
    ...
    var Panel = function (p) {
            ...
            return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.init = function () {
                ...
                t.panel.close("left" === n ? "right" : "left", e), t.panel.allowOpen = !1, i[e ? "removeClass" : "addClass"]("not-animated"), i.css({
                    display: "block"
                }).addClass("panel-active"), o[e ? "removeClass" : "addClass"]("not-animated"), o.show(), a._clientLeft = i[0].clientLeft, $("html").addClass("with-panel with-panel-" + n + "-" + r), a.onOpen();
            ...
            function e(t, a) {
                ...
                function P(e) {
                    if (!g && (o.params.draggableBar || 0 !== $(e.target).closest(".range-knob").length)) {
                        ...
                        a = o.dual ? Math.abs(o.value[0] - a) < Math.abs(o.value[1] - a) ? (k = 0, E = o.knobs[0], [a, o.value[1]]) : (k = 1, E = o.knobs[1], [o.value[0], a]) : (E = o.knobs[0], t * (o.max - o.min) + o.min), Utils.nextTick(function () {
    ...
    var Picker = function (c) {
            ...
            function e(t, s) {
                ...
                l.done = function () {
                    return (f ? c : p).transitionEnd(function () {
                        p.removeClass("ptr-transitioning ptr-pull-up ptr-pull-down"), p.trigger("ptr:done"), l.emit("local::done ptrDone", p[0])
                    }), p.removeClass("ptr-refreshing").addClass("ptr-transitioning"), l
                }, l.refresh = function () {
                    return p.hasClass("ptr-refreshing") || (p.addClass("ptr-transitioning ptr-refreshing"), p.trigger("ptr:refresh", l.done), l.emit("local::refresh ptrRefresh", p[0], l.done)), l
                };
        ...
        Searchbar = function (k) {
            ...
            return k && (e.__proto__ = k), ((e.prototype = Object.create(k && k.prototype)).constructor = e).prototype.clear = function (e) {
                ...
                var t = e.app;
                return e.$inputEl.val("").trigger("change"), e.$el.removeClass("searchbar-enabled searchbar-focused searchbar-enabled-no-disable-button"), !e.expandable && e.$disableButtonEl && 0 < e.$disableButtonEl.length && "ios" === t.theme && e.$disableButtonEl.css("margin-" + (t.rtl ? "left" : "right"), -e.disableButtonEl.offsetWidth + "px"), e.$backdropEl && (e.$searchContainer && e.$searchContainer.length || e.params.customSearch) && e.backdropHide(), e.enabled = !1, e.$inputEl.blur(), e.$hideOnEnableEl && e.$hideOnEnableEl.removeClass("hidden-by-searchbar"), e.$el.trigger("searchbar:disable"), e.emit("local::disable searchbarDisable", e), e
    ...
    function updateProgress(e) {
        ...
        var t = this,
            ...
            s = i,
            l = o;
        o = 0 === n ? i = !(r = 0) : (i = (r = (e - t.minTranslate()) / n) <= 0, 1 <= r), Utils.extend(t, {
            progress: r,
            isBeginning: i,
            isEnd: o
    ...
    function setBreakpoint() {
        ...
        if (i && (!i || 0 !== Object.keys(i).length)) {
            ...
            if (o && e.currentBreakpoint !== o) {
                ...
                }), e.currentBreakpoint = o, p && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
            }
        }
    }
    ...
    var breakpoints = {
        ...
        Browser = {
            ...
            isSafari: (r3a = win.navigator.userAgent.toLowerCase(), 0 <= r3a.indexOf("safari") && r3a.indexOf("chrome") < 0 && r3a.indexOf("android") < 0),
    ...
    var checkOverflow$1 = {
        ...
        Swiper = function (u) {
            function h() {
                ...
                (r = 1 === a.length && a[0].constructor && a[0].constructor === Object ? a[0] : (t = (e = a)[0], e[1])) || (r = {}), r = Utils.extend({}, r), t && !r.el && (r.el = t), u.call(this, r), Object.keys(prototypes).forEach(function (t) {
                ...
                t.vi = {
                    ...
                    loadSdk: function () {
                        if (!t.vi.sdkReady) {
                            ...
                            }, e.src = "../../../c.vi-serve.com/viadshtml/vi.min.js", $("head").append(e)
                        }
                    }
                }
            },
